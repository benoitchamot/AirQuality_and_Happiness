# Country code imported from Wikipedia
# Source: https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
# XK: Kosovo has been added to the list

country_code_dict = {"AD": "Andorra",
...
def get_country(code):
    ...
    try:
        ...
        print('ERROR: This country code does not match any country')
        return -1
    
# Source: https://galeascience.wordpress.com/2016/03/23/us-city-to-state-python-dictionary/
# Added:
# - "Queens": "New York"
...
def get_state(city):
    ...
    if city == 'Washington D.C.':
        ...
        try:
            ...
            print('ERROR: This city name does not match any state')
            return -1